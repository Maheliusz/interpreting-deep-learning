...
if __name__ == '__main__':
    ...
    tree = SDT(learner_args).to(device) if not args.load else torch.load(PATH)
    ...
    print('\nTesting Accuracy: {}/{} ({:.3f}%) | Historical Best: {:.3f}%\n'.format(correct, len(test_loader.dataset), accuracy, best_testing_acc))
